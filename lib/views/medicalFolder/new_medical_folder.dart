...
import 'package:glucotel/views/medicalFolder/new_medical_folder_two.dart';
import 'package:page_transition/page_transition.dart';

class NewMedicalFolderScreen extends StatefulWidget {
  const NewMedicalFolderScreen({Key? key}) : super(key: key);

  @override
  State<NewMedicalFolderScreen> createState() => _NewMedicalFolderScreenState();
}

class _NewMedicalFolderScreenState extends State<NewMedicalFolderScreen> {
                            ...
                            onTap: () async {
                              ...
                              if (isValid) {
                                ...
                                await Navigator.push(
                                  context,
                                  PageTransition(
                                    child: const NewFolderScreenTwo(),
