...
import 'package:glucotel/views/medicalFolder/new_medical_folder_three.dart';
import 'package:page_transition/page_transition.dart';

class NewFolderScreenTwo extends StatefulWidget {
  const NewFolderScreenTwo({Key? key}) : super(key: key);

  @override
  State<NewFolderScreenTwo> createState() => _NewFolderScreenTwoState();
}

class _NewFolderScreenTwoState extends State<NewFolderScreenTwo> {
  bool _hta = false;
                        ...
                        if (isValid) {
                          await SessionManager()
                            ...
                            await Navigator.push(
                              context,
                              PageTransition(
                                child: const NewMedicalFolderThree(),
